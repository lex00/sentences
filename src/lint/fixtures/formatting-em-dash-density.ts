...
export const fixtures: RuleFixtures = {
  ...
  positives: [
    { text: twoDash, spanText: "—", profile: "rate", note: "em dash occurrence, high density (>=6/1000)" },
    { text: twoDash, spanText: "--", profile: "rate", note: "double-hyphen-as-dash occurrence, same document" },
  ],
  negatives: [
    {
